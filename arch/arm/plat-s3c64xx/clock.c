...
static const u32 s3c_cpu_clk_tab_533MHz[][6] = {
	{1330*MHZ, 333 *MHZ, 665, 3, 0, 3},
	{665*MHZ, 333 *MHZ, 665, 3, 1, 3},
	{332*MHZ, 333 *MHZ, 665, 3, 3, 3},
#ifdef USE_DVFS_AL1_LEVEL
	{332*MHZ, 333 *MHZ, 665, 1, 3, 3},
#endif /* USE_DVFS_AL1_LEVEL */
	{ 166*MHZ, 333 *MHZ, 665, 1, 7, 3},
};

/* ARMCLK, HCLKX2, APLL, PDIV, ARM_DIV, HCLKX2_DIV */
static const u32 s3c_cpu_clk_tab_800MHz[][6] = {
	{2000*MHZ,  333 *MHZ, 1000, 3, 0, 5},
	{1000*MHZ,  333 *MHZ, 1000, 3, 1, 5},
	{666*MHZ,  333 *MHZ, 1000, 3, 2, 5},
	{333*MHZ,  333 *MHZ, 1000, 3, 5, 5},
#ifdef USE_DVFS_AL1_LEVEL
	{333*MHZ,  333 *MHZ, 1000, 1, 5, 5},
#endif /* USE_DVFS_AL1_LEVEL */
	{ 166*MHZ,  333 *MHZ, 1000, 1, 11, 5},
};
